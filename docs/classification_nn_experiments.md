...
报告图表由 `src/plot_results.py report-figures` 生成，当前保留在 `results/report_figures/`
...
```text
results/confusion_matrices/iris_mlp_iris_val_confusion.pdf
results/tables/iris_mlp_iris_val_confusion.csv
results/confusion_matrices/mnist_mlp_mnist_val_confusion.pdf
